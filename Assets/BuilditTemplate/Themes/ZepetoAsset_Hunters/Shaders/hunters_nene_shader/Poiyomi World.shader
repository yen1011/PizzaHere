Shader "Hidden/Locked/.poiyomi/Poiyomi 8.0/Poiyomi World/c4d7f94bf1387bc408f037ce591ba8b4"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyMatcap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, inout PoiLight poiLight, in PoiMods poiMods)
			{
				...
				#if defined(PROP_MATCAP) || !defined(OPTIMIZER_ENABLED)
				matcap = UNITY_SAMPLE_TEX2D_SAMPLER(_Matcap, _MainTex, TRANSFORM_TEX(matcapUV, _Matcap)) * float4(poiThemeColor(poiMods, float4(1,0.4858491,0.8868538,1).rgb, (0.0 /*_MatcapColorThemeIndex*/)), float4(1,0.4858491,0.8868538,1).a);
				#else
				matcap = float4(poiThemeColor(poiMods, float4(1,0.4858491,0.8868538,1).rgb, (0.0 /*_MatcapColorThemeIndex*/)), float4(1,0.4858491,0.8868538,1).a);
				#endif
				matcap.rgb *= (1.67 /*_MatcapIntensity*/);
				#if defined(PROP_MATCAPMASK) || !defined(OPTIMIZER_ENABLED)
				...
				{
					matcap.rgb = hueShift(matcap.rgb, (0.283 /*_MatcapHueShift*/) + _Time.x * (10.0 /*_MatcapHueShiftSpeed*/));
				}
				blendMatcap(poiLight, poiFragData, (0.0 /*_MatcapAdd*/), (0.0 /*_MatcapAddToLight*/), (0.0 /*_MatcapMultiply*/), (1.0 /*_MatcapReplace*/), (0.0 /*_MatcapMixed*/), matcap, matcapMask, (0.0 /*_MatcapEmissionStrength*/), (0.0 /*_MatcapLightMask*/)
				#ifdef POI_BLACKLIGHT
