...
Shader "Particle/FX_Master_AddtiveColor_Two"
{
	Properties
	{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float4 tex2DNode25 = tex2D( _Main_Texture, ( ( UnpackNormal( tex2D( _Distortion_Texture, uv_TexCoord51 ) ) * (( _Use_CustomData )?( i.uv3_tex3coord3.y ):( _Distortion_Intensity )) ) + float3( uv_TexCoord26 ,  0.0 ) ).xy );
			o.Emission = ( (( _Use_CustomData )?( i.uv3_tex3coord3.x ):( _Burn )) * ( ( _Color1 * tex2DNode25 ) * i.vertexColor ) ).rgb;
			...
			float4 clampResult119 = clamp( ( temp_output_108_0 * pow( ( ( 0.5 * temp_output_108_0 ) + (( _Use_CustomData )?( i.uv3_tex3coord3.z ):( _Dissolve )) ) , temp_cast_7 ) ) , float4( 0,0,0,0 ) , float4( 1,0,0,0 ) );
...
/*ASEBEGIN
Version=18800
1676;293;1624;741;2389.024;286.4402;1.3;True;True
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;122;-2967.041,-6.196185;Inherit;False;2;-1;3;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ToggleSwitchNode;123;-2376.06,-183.6621;Float;False;Property;_Use_CustomData;Use_CustomData;16;0;Create;True;0;0;0;False;0;False;0;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;108;-3198.004,872.9251;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;109;-3241.673,679.324;Float;False;Constant;_Float0;Float 0;15;0;Create;True;0;0;0;False;0;False;0.5;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;107;-3126.092,1097.02;Float;False;Property;_Dissolve;Dissolve;14;0;Create;True;0;0;0;False;0;False;1;0.95;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ToggleSwitchNode;125;-2881.632,1041.475;Float;False;Property;_Use_CustomData;Use_CustomData;17;0;Create;True;0;0;0;False;0;False;0;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;110;-2920.679,863.3344;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleAddOpNode;111;-2614.269,771.8807;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;116;-2563.674,1094.46;Float;False;Property;_Dissolve_Sharpness;Dissolve_Sharpness;15;0;Create;True;0;0;0;False;0;False;5.696;3.44;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.PowerNode;115;-2288.289,727.2889;Inherit;False;False;2;0;COLOR;0,0,0,0;False;1;FLOAT;1;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;114;-1894.453,839.8241;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;126;-1569.236,-107.9707;Inherit;False;Property;_Color1;Color;17;0;Create;True;0;0;0;False;0;False;1,1,1,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ClampOpNode;119;-1627.621,625.3905;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;1,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;120;-1296.21,529.9896;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;79;-1299.473,-107.7421;Float;False;Property;_Burn;Burn;7;0;Create;True;0;0;0;False;0;False;1;12.1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.VertexColorNode;76;-1396.147,266.905;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;127;-1225.236,69.02927;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;78;-1122.521,318.7695;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.ToggleSwitchNode;124;-1076.71,-86.34067;Float;False;Property;_Use_CustomData;Use_CustomData;16;0;Create;True;0;0;0;False;0;False;0;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;104;-817.5339,315.3332;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=5C104D6B9331A40AEACFFC0BA61C7248ABCE1721